...
ImGuiStyle::ImGuiStyle()
{
    ...
    WindowRounding = 31.0f;             // Radius of window corners rounding. Set to 0.0f to have rectangular windows. Large values tend to lead to variety of artifacts and are not recommended.
    ...
    GrabRounding = 9.0f;             // Radius of grabs corners rounding. Set to 0.0f to have rectangular slider grabs.
