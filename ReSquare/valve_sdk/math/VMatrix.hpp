...
public:
    ...
    matrix3x4_t Multiply(matrix3x4_t m) 
    { 
        matrix3x4_t ret;
        for (int i = 0; i < 3; i++) {
            for (int j = 0; j < 4; j++) {
    ...
    Vector matrix3x4_t::operator*(const Vector& other) const {
        Vector vRet;
        vRet.x = m_flMatVal[0][0] * other.x + m_flMatVal[0][1] * other.y + m_flMatVal[0][2] * other.z + m_flMatVal[0][3];
        vRet.y = m_flMatVal[1][0] * other.x + m_flMatVal[1][1] * other.y + m_flMatVal[1][2] * other.z + m_flMatVal[1][3];
        vRet.z = m_flMatVal[2][0] * other.x + m_flMatVal[2][1] * other.y + m_flMatVal[2][2] * other.z + m_flMatVal[2][3];
        return vRet;
    }
