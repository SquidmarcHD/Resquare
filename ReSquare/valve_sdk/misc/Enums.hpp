...
enum ItemDefinitionIndex
{
	...
	WEAPON_SNOWBALL,
	WEAPON_BUMPMINE,
	WEAPON_BAYONET = 500, //500,505,506,507,508,509,512,514,515,516,519,520,522,523
	WEAPON_KNIFE_FLIP = 505,//"Bayonet", "Flip", "Gut", "Karambit", "M9 Bayonet", "Huntsman", "Falchion", "Bowie", "Butterfly", "Daggers", "Ursus", "Navaja", "Stiletto", "Talon"
	WEAPON_KNIFE_GUT,
